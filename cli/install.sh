...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.3.6}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "70aa1cbf15c595de94bded8847ff2f83dfed1a19c5acbe9df4aa11f05b2144c4" ;;
    normal) echo "035e1e419eee687b9f1147c790b5ecb870d0943ccd6f5b96901a9372f89f44f8" ;;
  esac
}
