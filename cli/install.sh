...
tarball_sha256() {
  case "$1" in
    glass)  echo "87c139fa97bc31d4f1d8c3ca7954e572126b5c8bce2e183d1c5ab59e14ef8397" ;;
    normal) echo "ec6e34228b7c7a8cfbef8df3a6893fad3612ad8a6b2116474d3e80f22b687e67" ;;
  esac
}
