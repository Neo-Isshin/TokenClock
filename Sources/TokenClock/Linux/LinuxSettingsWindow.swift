...
final class LinuxSettingsWindow: @unchecked Sendable {
    ...
    static let toolOptions: [ToolOption] = [
        ...
        .init(emoji: "❇️", name: "Gemini CLI", service: "gemini", pathKey: .geminiPath),
        .init(emoji: "⚛️", name: "Codex", service: "codex", pathKey: .codexPath),
        ...
        .init(emoji: "♻️", name: "Qwen Code", service: "qwen", pathKey: .qwenPath),
        ...
        .init(emoji: "🔃", name: "Antigravity", service: "antigravity", pathKey: .antigravityPath),
