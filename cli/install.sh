...
tarball_sha256() {
  case "$1" in
    glass)  echo "fb360b7e466741fabb4d78be8bb10a6d040802cf65784fa91e1e914daf6e07f2" ;;
    normal) echo "c7bf4a61659eea2fc2e95d669bd32a7cb9efd6303d77ac626770c4d5c95dcd1b" ;;
  esac
}
