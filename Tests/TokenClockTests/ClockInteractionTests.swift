...
final class ClockInteractionTests: XCTestCase {
    func testNormalQuickTextColorPresetIsDerivedOnlyFromDetailPanelColor() {
        XCTAssertEqual(QuickContrastPreset.matchingPanelColor("#ffffff"), .light)
        XCTAssertEqual(QuickContrastPreset.matchingPanelColor("#000000"), .dark)
        XCTAssertEqual(QuickContrastPreset.matchingPanelColor("#FFD60A"), .amber)
        XCTAssertNil(QuickContrastPreset.matchingPanelColor(nil))
        XCTAssertNil(QuickContrastPreset.matchingPanelColor("#123456"))
    }
