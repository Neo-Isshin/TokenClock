...
/// 详情面板中的高对比度快捷配色。右键菜单仍可分别精细设置两处颜色；
/// 快捷按钮只在用户主动点击时同时覆盖表盘与详情文字色。
