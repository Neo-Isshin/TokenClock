...
tarball_sha256() {
  case "$1" in
    glass)  echo "96abdfcd97208c878a7e2d2e354118c241cc1306a378952ad349480472d6c5a3" ;;
    normal) echo "c36d9cae43cb1340f20c0f4cb26143346aea707176d5df75eb273cac5273aa8c" ;;
  esac
}
