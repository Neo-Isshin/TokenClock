...
final class L10n: @unchecked Sendable {
    ...
    private let table: [String: [AppLanguage: String]] = [
        ...
        "detail.byCost":         [.zhHans: "按等价费用", .zhHant: "按等價費用", .en: "By API Eq."],
        "detail.valueModeHelp":  [.zhHans: "切换 用量+消息数 / API 等价费用+占比", .zhHant: "切換 用量+訊息數 / API 等價費用+佔比", .en: "Toggle usage+msgs / API-equivalent cost+percent"],
