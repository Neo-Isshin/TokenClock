...
tarball_sha256() {
  case "$1" in
    glass)  echo "6b34f758026257488458fb8a4f840109b3d2f0ba2e317fefe9e925280d33c6a2" ;;
    normal) echo "1c67a74db9a1ee0e592090d18b99a452af35663b40fec0932c5295202ee274df" ;;
  esac
}
