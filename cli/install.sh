...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.2.1}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "f402a62654ea25339eb60d7ccabdbb751782f56b51b7199b554822cd9e00add3" ;;
    normal) echo "0030989589e549fbdc8834231043cf7a2374041ad82b53538148685e08cade3d" ;;
  esac
}
