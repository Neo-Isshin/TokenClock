...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.3.4}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "0bd37b53fae27c773973160824ba73dccaeae057b8ffb1932f7532ea26f974b4" ;;
    normal) echo "7270d0c5160876ec92b6078d768aecb824ac8026ed8b9677aaf775d267ecbcbe" ;;
  esac
}
