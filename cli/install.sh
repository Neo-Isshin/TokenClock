...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.2.2}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "41e224b5dc68e0da528d657c3e6e3813103eef50967e61c30d719cd0b039a65d" ;;
    normal) echo "63534cd2378726c4c423d40f8bc87cf4a145e9b2be6364dc1fc5235be8c086fa" ;;
  esac
}
