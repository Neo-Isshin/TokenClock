...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.2.3}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "64921de8a63bc96e9d13f61088aa973adf3441752bba67adc82b2b5599cffce9" ;;
    normal) echo "5af7f508e8731c9c49334695bbbc916c35c8f11d10e6d2ebdb6dfda0f247d6fb" ;;
  esac
}
