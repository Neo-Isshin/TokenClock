...
tarball_sha256() {
  case "$1" in
    glass)  echo "408f3556380933968d9b5db62e35083debeff5fa8337debbe656c1266373ec1e" ;;
    normal) echo "c8a0f12acc15a10a4184b47cdb87ca051094cb5ebcab153094fd32ec8d19a75c" ;;
  esac
}
