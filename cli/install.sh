...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.2.6}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "e2a43ee2b8777b4e11b0773c4253ff09c0df222d11d4dbb0ea4844841e2625dd" ;;
    normal) echo "bf6f2e03944465c8a503774a908376ed0703d18cc3cf3fe7095ac67763975904" ;;
  esac
}
