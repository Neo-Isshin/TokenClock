...
RELEASE_TAG="${TOKENCLOCK_RELEASE_TAG:-v1.3.3}"
...
tarball_sha256() {
  case "$1" in
    glass)  echo "f14211cd7c3c510391c24a1154627e00051a877b043e17b8ff59aa7a84250730" ;;
    normal) echo "a6680836828e90c90d4d07715b50b15bf751dd069ae6de5f12a50fe81b336351" ;;
  esac
}
