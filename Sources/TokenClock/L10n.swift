...
final class L10n: @unchecked Sendable {
    ...
    private let table: [String: [AppLanguage: String]] = [
        ...
        "settings.hint.envVars":    [.zhHans: "支持环境变量覆盖：OPENCLAW_HOME、CLAUDE_CONFIG_DIR、GEMINI_HOME、CODEX_HOME、HERMES_HOME", .zhHant: "支持環境變量覆蓋：OPENCLAW_HOME、CLAUDE_CONFIG_DIR、GEMINI_HOME、CODEX_HOME、HERMES_HOME", .en: "Env vars: OPENCLAW_HOME, CLAUDE_CONFIG_DIR, GEMINI_HOME, CODEX_HOME, HERMES_HOME"],
