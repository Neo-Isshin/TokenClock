...
tarball_sha256() {
  case "$1" in
    glass)  echo "1bdef4131c24997f4df53aa368a62711168cfefa4816ad9f853b7a449023b0b1" ;;
    normal) echo "e3e322d0eaf4af16a892c3e8c5d1a824bd018e679990cbc7570eae96b1f3bf28" ;;
  esac
}
