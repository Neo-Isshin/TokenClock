...
final class ClaudeQuotaServiceTests: XCTestCase {
    func testDetailedPlanDistinguishesMaxTiers() {
        XCTAssertEqual(ClaudeQuotaService.detailedPlan(subscriptionType: "max", rateLimitTier: "default_claude_max_5x"), "max_5x")
        XCTAssertEqual(ClaudeQuotaService.detailedPlan(subscriptionType: "max", rateLimitTier: "default_claude_max_20x"), "max_20x")
        XCTAssertEqual(ClaudeQuotaService.detailedPlan(subscriptionType: "pro", rateLimitTier: "default_claude_ai"), "pro")
    }
