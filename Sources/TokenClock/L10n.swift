...
final class L10n: @unchecked Sendable {
    ...
    private let table: [String: [AppLanguage: String]] = [
        ...
        "overview.cost":         [.zhHans: "估算费用", .zhHant: "估算費用", .en: "Est. Cost"],
        ...
        "quota.dialDisplayHelp": [.zhHans: "选择表盘额度环展示的工具", .zhHant: "選擇錶盤額度環顯示的工具", .en: "Choose the quota shown on the dial"],
        ...
        "quota.providersSummary":[.zhHans: "5 个本机服务", .zhHant: "5 個本機服務", .en: "5 local providers"],
